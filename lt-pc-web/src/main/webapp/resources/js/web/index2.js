...
$(function(){
    ...
    $("#kclb").click(function(){
        $(".wlz2 .wlz2_right .right_bottom_w dd div span").text("空车列表");
    });
    $("#ydcx").click(function(){
    ...
    $('.fenlei ul li').mouseenter(function(){
        ...
        $(this).children().children().css('color','#de2a36');
        $(this).children().children().children().css('color','#de2a36');
        //for(var i=0;i<1;i++){
...
$(function(){
    ...
    $(".newcar").css({"border-width":"3px","border-color":"#0f5489","border-bottom-color":"#FFF"})
    $(".newcar1").css({"border-width":"3px","border-color":"#0f5489","border-bottom-color":"#FFF"})
    $(".d").css({"border-width":"3px","border-color":"#0f5489","border-bottom-color":"#FFF"})
});
...
function open1(){
    ...
    $("#shop2").css({"display":"none"});
    $(".newcar").css({"border-width":"3px","border-color":"#0f5489","border-bottom-color":"#FFF"})
    $(".oldcar").css({"border-width":"0px","border-color":"#0f5489","border-bottom-color":"#FFF"})
}
function open2(){
    $("#shop").css({"display":"none"});
    $("#shop2").css({"display":"block"});
    $(".oldcar").css({"border-width":"3px","border-color":"#0f5489","border-bottom-color":"#FFF"})
    $(".newcar").css({"border-width":"0px","border-color":"#0f5489","border-bottom-color":"#FFF"})
}
function open3(){
    $("#shop3").css({"display":"block"});
    $("#shop4").css({"display":"none"});
    $(".newcar1").css({"border-width":"3px","border-color":"#0f5489","border-bottom-color":"#FFF"})
    $(".oldcar1").css({"border-width":"0px","border-color":"#0f5489","border-bottom-color":"#FFF"})
}
function open4(){
    $("#shop3").css({"display":"none"});
    $("#shop4").css({"display":"block"});
    $(".oldcar1").css({"border-width":"3px","border-color":"#0f5489","border-bottom-color":"#FFF"})
    $(".newcar1").css({"border-width":"0px","border-color":"#0f5489","border-bottom-color":"#FFF"})
}
function open5(){
    $("#shop5").css({"display":"block"});
    /*$(".d").css({"border-width":"3px","border-color":"#0f5489","border-bottom-color":"#FFF"})
    $(".e").css({"border-width":"0px","border-color":"#0f5489","border-bottom-color":"#FFF"})
    $(".f").css({"border-width":"0px","border-color":"#0f5489","border-bottom-color":"#FFF"})
    $(".g").css({"border-width":"0px","border-color":"#0f5489","border-bottom-color":"#FFF"})
    $(".h").css({"border-width":"0px","border-color":"#0f5489","border-bottom-color":"#FFF"})*/
}
function open6(){
    $("#shop5").css({"display":"block"});
  /*  $(".e").css({"border-width":"3px","border-color":"#0f5489","border-bottom-color":"#FFF"})
    $(".f").css({"border-width":"0px","border-color":"#0f5489","border-bottom-color":"#FFF"})
    $(".g").css({"border-width":"0px","border-color":"#0f5489","border-bottom-color":"#FFF"})
    $(".h").css({"border-width":"0px","border-color":"#0f5489","border-bottom-color":"#FFF"})
    $(".d").css({"border-width":"0px","border-color":"#0f5489","border-bottom-color":"#FFF"})*/
}
function open7(){
    $("#shop5").css({"display":"block"});
 /*   $(".f").css({"border-width":"3px","border-color":"#0f5489","border-bottom-color":"#FFF"})
    $(".g").css({"border-width":"0px","border-color":"#0f5489","border-bottom-color":"#FFF"})
    $(".h").css({"border-width":"0px","border-color":"#0f5489","border-bottom-color":"#FFF"})
    $(".d").css({"border-width":"0px","border-color":"#0f5489","border-bottom-color":"#FFF"})
    $(".e").css({"border-width":"0px","border-color":"#0f5489","border-bottom-color":"#FFF"})*/
...
function open8(){
    $("#shop5").css({"display":"block"});
   /* $(".g").css({"border-width":"3px","border-color":"#0f5489","border-bottom-color":"#FFF"})
    $(".h").css({"border-width":"0px","border-color":"#0f5489","border-bottom-color":"#FFF"})
    $(".d").css({"border-width":"0px","border-color":"#0f5489","border-bottom-color":"#FFF"})
    $(".e").css({"border-width":"0px","border-color":"#0f5489","border-bottom-color":"#FFF"})
...
function open9(){
    $("#shop5").css({"display":"block"});
    /*$(".h").css({"border-width":"3px","border-color":"#0f5489","border-bottom-color":"#FFF"})
    $(".d").css({"border-width":"0px","border-color":"#0f5489","border-bottom-color":"#FFF"})
    $(".e").css({"border-width":"0px","border-color":"#0f5489","border-bottom-color":"#FFF"})
    $(".f").css({"border-width":"0px","border-color":"#0f5489","border-bottom-color":"#FFF"})
    $(".g").css({"border-width":"0px","border-color":"#0f5489","border-bottom-color":"#FFF"})*/
...
$(function(){
    ...
    $('.fenlei1 ul li').mouseenter(function(){
        ...
        if(this_text=="fenleiLeft_kc"){
            $('.fenleiright').stop().animate({'width':'0px'},300);
            $('#fenleiright_kc').fadeTo(0,1).stop().animate({'width':'960px'},300);
        }else if(this_text=="fenleiLeft_jc"){
            $('.fenleiright').stop().animate({'width':'0px'},300);
            $('#fenleiright_jc').fadeTo(0,1).stop().animate({'width':'960px'},300);
        }else if(this_text=="fenleiLeft_pj"){
            $('.fenleiright').stop().animate({'width':'0px'},300);
            $('#fenleiright_pj').fadeTo(0,1).stop().animate({'width':'960px'},300);
        }else{
            $('.fenleiright').stop().animate({'width':'0px'},300);
        }
