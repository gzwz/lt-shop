    ...
    var step = {
        ...
        Creat_Table: function () {
            ...
            if (bCheck == true) {
                var RowsCount = 0;
                $("#createTable").html("");
                var table = $("<table id=\"process\" class=\"table table-striped table-bordered table-condensed\"></table>");
                ...
                if (zuheDate.length > 0) {
                    ...
                    $.each(zuheDate, function (index, item) {
                        ...
                        var td1 = $("<td ><input name=\"prices\" class=\"l-text\" type=\"text\" value=\"0\"></td>");
                        td1.appendTo(tr);
                        var td2 = $("<td ><input name=\"numbers\" class=\"l-text\" type=\"text\" value=\"0\"></td>");
                        td2.appendTo(tr);
