...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
        , serverUrl:contextPath + "/ueditor_config"//URL + "jsp/controller.jsp"
       //  , serverUrl:"http://admin.e-kcw.com/ueditor_config"//URL + "jsp/controller.jsp"
        ...
        /*, toolbars: [[
            ...
            'simpleupload', 'insertimage', 'emotion', 'scrawl', 'insertvideo', 'attachment', 'pagebreak', 'background', '|',
    ...
    , toolbars: [[   
    	...
    	/*'fullscreen', 'autotypeset', 'source', 'music', 'map', 'gmap', 'insertframe', 'insertcode', 'webapp', 'template', 'snapscreen', 'wordimage','print', 'preview', 'help', 'drafts'*/
