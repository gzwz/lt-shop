...
import lt.pay.alipay.config.AlipayConfig;
import lt.pay.alipay.sign.MD5;
import lt.pay.alipay.util.httpClient.HttpProtocolHandler;
import lt.pay.alipay.util.httpClient.HttpRequest;
import lt.pay.alipay.util.httpClient.HttpResponse;
import lt.pay.alipay.util.httpClient.HttpResultType;
...
public class AlipaySubmit {
	...
	public static String query_timestamp() throws MalformedURLException,
                                                        DocumentException, IOException, JDOMException {
  ...
  //      System.out.println(data); 
     ...
     //   System.out.println("根节点：" + rootElt.getName()); // 拿到根节点的名称  
        String is_success = rootElt.elementText("is_success"); 
        Element element = (Element) rootElt.element("response");
        String encrypt_key= ((Element) element.element("timestamp")).elementText("encrypt_key");
        
        if (is_success.equals("is_success") && encrypt_key.equals("T")) {
        	result.append(encrypt_key);
        }
